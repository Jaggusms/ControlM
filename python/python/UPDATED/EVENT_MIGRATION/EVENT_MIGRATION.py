...
if re.findall('(?i)Dev', ENV):
    REPLACE(data,ENV,'D',"$ES4",'$ES7',"SDM4","SDM7","ESPP.ES4M","ESPT.ES7M",".PROD.",".DEV.")
elif re.findall('(?i)Sit2', ENV):
    REPLACE(data,ENV,'2','','','','',"","",".DEV.",".SIT2.")
elif re.findall('(?i)Sit', ENV):
    REPLACE(data,ENV,'S','','','','',"","",".DEV.",".SIT.")
elif re.findall('(?i)Uat', ENV):
    REPLACE(data,ENV,'U','','','','',"","",".SIT.",".UAT.")
elif re.findall('(?i)Ir', ENV):
    REPLACE(data,ENV,'P','','','','',"","",".UAT.",".IR.")
elif re.findall('(?i)Prod', ENV):
    REPLACE(data,ENV,'P','$ES7','$ES4','SDM7','SDM4',"ESPT.ES7M","ESPP.ES4M",".IR.",".PROD.")
elif re.findall('(?i)Ft', ENV):
    REPLACE(data,ENV,'F',"$ES4",'$ES7',"SDM4","SDM7","ESPP.ES4M","ESPT.ES7M",".PROD.",".FT.")
else:
