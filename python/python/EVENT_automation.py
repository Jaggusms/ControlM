            ...
            for data,row in df2.iterrows():
                if row[2].upper()=="TRANSFER":
                    ...
                    if SCHEDULE.upper()=="AUTO":
                        commands.append('zowe endevor transfer element {1} --env SUPP --sys {4} --sub {2} --typ EVENTS --sn 2 --ccid {0} --com "{5} AUTO" --toenv SUPP --tosys {4} --tosub {3} --toele {1} --totyp EVENTS --tosn 2 --sync --pg APPL --bed'.format(RITM,appl,environment,environment_1,application,Promotion))									  
                    else:
                        commands.append('zowe endevor transfer element {1} --env SUPP --sys {4} --sub {2} --typ EVENTS --sn 2 --ccid {0} --com "{5}" --toenv SUPP --tosys {4} --tosub {3} --toele {1} --totyp EVENTS --tosn 2 --sync --pg APPL --bed'.format(RITM,appl,environment,environment_1,application,Promotion))									  
                ...
                if row[2].upper()=="UPDATE":
                    ...
                    application=SourcCrosswalk.split(".")[3]
                    if SCHEDULE.upper()=="AUTO":
                        commands.append('zowe endevor update element{1} --env SUPP --sys {3} --sub {4} --typ EVENTS --fd {2} --fm {1} --os --ccid {0} --com "DEFAULT AUTO" --g'.format(RITM,appl,SourcCrosswalk,application,environment))
                    else:
                        commands.append('zowe endevor update element{1} --env SUPP --sys {3} --sub {4} --typ EVENTS --fd {2} --fm {1} --os --ccid {0} --com "DEFAULT" --g'.format(RITM,appl,SourcCrosswalk,application,environment))
                ...
                if row[2].upper()=="ADD":
                    ...
                    application=SourcCrosswalk.split(".")[3]
                    if SCHEDULE.upper()=="AUTO":
                        commands.append('zowe endevor add element {1} --env SUPP --sys {3} --sub {4} --typ EVENTS --fd {2} --fm {1} --os --ccid {0} --com "DEFAULT AUTO" --g'.format(RITM,appl,SourcCrosswalk,application,environment))
                    else:
                        commands.append('zowe endevor add element {1} --env SUPP --sys {3} --sub {4} --typ EVENTS --fd {2} --fm {1} --os --ccid {0} --com "DEFAULT" --g'.format(RITM,appl,SourcCrosswalk,application,environment))
                ...
                if row[2].upper()=="MOVE":
                    ...
                    application=SourcCrosswalk.split(".")[3]
                    if SCHEDULE.upper()=="AUTO":
                        commands.append('zowe endevor move element {1} --env SUPP -sys {2} --sub {3} --typ EVENTS --sn 2 --ccid {0} --com "{4} AUTO" --sync'.format(RITM,appl,application,environment_1,Promotion))     
                    else:
                        commands.append('zowe endevor move element {1} --env SUPP -sys {2} --sub {3} --typ EVENTS --sn 2 --ccid {0} --com "{4}" --sync'.format(RITM,appl,application,environment_1,Promotion))     
