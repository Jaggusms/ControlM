...
import re
xml_file,ESP,Impacted,APPL_Final_Rename_Sheet=sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4]
...
xml_df[xml_df.columns[2]]=[str(i) for i in xml_df[xml_df.columns[2]]]
...
Quantitative_df[Quantitative_df.columns[2]]=[str(i) for i in Quantitative_df[Quantitative_df.columns[2]]]
...
Wave3_APPL_Final_df=pd.read_excel(APPL_Final_Rename_Sheet,sheet_name=0,usecols="H,K")
...
Wave3_Impacted_df=pd.read_excel(Impacted,sheet_name=0,usecols="E,H").fillna("")
...
Wave3_new_df["Impacted Job Name "]=new
